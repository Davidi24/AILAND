  ...
  return (
    <div
      className={
        ...
        "bg-white " +
        "dark:bg-white/5 dark:backdrop-blur-lg dark:backdrop-saturate-150 " +
        "border-gray-200 dark:border-white/10 hover:dark:border-white/20 hover:dark:shadow-[0_0_25px_rgba(255,255,255,0.08)] " +
