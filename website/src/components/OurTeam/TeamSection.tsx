...
export default function TeamSection() {
  ...
  return (
    <section className="relative mx-auto max-w-7xl px-6 py-24">
      <SectionTitle
        title="Our Team"
        subtitle="Meet the people behind our semantic XR vision."
      />

      <motion.div
        ref={ref}
        className="mt-14 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-8"
